...
<head>
    ...
    <title>Attendance Student | Môn học </title>
        ...
        <div class="main-content">
            <div id="formMaincontent" class="form-container container-lg">
                ...
                <form class="formSearch">
                    <input type="text" class="textSearch form-check-label" placeholder="Tìm tên, mã môn..">
            ...
            <div id="formthem" class="form-container" style="display: none;">
                <form class="form" action="" method="POST" name="" enctype="multipart/form-data">
                    <div class="title">
                        <h4 class="p">Thêm môn học</h4>
                    </div>
                    <div class="mb-3">
                        <label for="ten" class="lable form-label">Tên môn</label>
